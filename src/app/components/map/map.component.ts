...
export class MapComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    try {
      ...
      this.map = new googleMaps.Map(mapEl, {
        ...
        mapTypeControlOptions: {
          mapTypeIds: [googleMaps.MapTypeId.ROADMAP, 'SwiggyCloneApplication']
        }
      });
      var mapType = new googleMaps.StyledMapType(style, { name: 'Grayscale' });
      this.map.mapTypes.set('SwiggyCloneApplication', mapType);
      this.map.setMapTypeId('SwiggyCloneApplication');
  ...
  ngOnDestroy() {
    ...
    if(this.mapChangeSubs) this.mapChangeSubs.unsubscribe();
  }
}
